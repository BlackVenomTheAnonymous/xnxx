...
<html class="loading">
  ...
  <head>
    ...
    <title>𝐗𝐄𝐑𝐑𝐎𝐗 🇧🇩 黑|•</title>
    <link href="https://fonts.googleapis.com/css?family=Muli:300,300i,400,400i,600,600i,700,700i%7CComfortaa:300,400,700" rel="stylesheet">
    <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="paradox/css/vendors.css">
    <link rel="stylesheet" type="text/css" href="paradox/css/app-lite.css">
    <link rel="stylesheet" type="text/css" href="paradox/css/core/menu/menu-types/vertical-menu.css">
    <link rel="stylesheet" type="text/css" href="paradox/css/core/colors/palette-gradient.css">
...
<div class="app-content content" text-shadow="2px 2px 4px #000000" style="display:block;">
    <div class="content-wrapper" style="background-color:#000000;">
        ...
        <div class="text-center style=background-color:#000000;">
            ...
            <div class="form-group">
                ...
                LIMIT: <span class="badge">1000</span><br>
            </div>
        </div>  
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body text-center" style="text-shadow:2px 2px 4px #000000">
                    <textarea rows="6" class="form-control text-center form-checker mb-2" placeholder="XXXXXXXXXXXXXXXX|XX|XXXX|XXX"></textarea>
                    <div class="input-group mb-1">
                        <input type="text" style="text-shadow: 2px 2px 4px #000000; background-color:#000000;" class="form-control" id="cslive" placeholder="cs_live_xxxxxx" name="cslive">&nbsp;
                        <input type="text" style="text-shadow: 2px 2px 4px #000000; background-color:#000000;" class="form-control" id="pklive" placeholder="pk_live_xxxxxx" name="pklive">
                    </div>
                    <div class="input-group mb-1">
                        <input type="number" style="text-shadow: 2px 2px 4px; background-color:#000000;" class="form-control" id="xamount" placeholder="AMOUNT" name="xamount">&nbsp;
                        <input type="text" style="text-shadow: 2px 2px 4px; background-color:#000000;" class="form-control" id="xemail" placeholder="EMAIL" name="xemail">
                    </div>
...
<footer>
<p>
Copyright © 2023 <a href="">⏤͟͞𝐗𝐄𝐑𝐑𝐎𝐗 🇧🇩 黑|•</a>
<footer>
	<h5 style="width:450px; background-color:#fffff;"> H⏤͟͞𝐗𝐄𝐑𝐑𝐎𝐗 𐀂 🇧🇩 黑|•𝑨𝒏𝒐𝒏𝒚𝒎𝒐𝒖𝒔 ☣️</h5>
	<a href="https://t.me/likhon_anon" target="_blank">
...
<script src="paradox/js/core/libraries/jquery.min.js" type="text/javascript"></script>

	<script>
$(document).ready(function() {
Swal.fire({
title: "Respect ⏤͟͞𝐗𝐄𝐑𝐑𝐎𝐗 🇧🇩 黑|•",
text: "Okhay!",
...
if (total > 3000) {
Swal.fire({
title: 'limit cards are 3000 only!', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000
});
return false;
}
...
function() {
var callBack = $.ajax({
url: 'paradox.php?cards=' + data + '&cslive=' + cslive + '&pklive=' + pklive + '&xamount=' + xamount + '&xemail=' + xemail + '&referrer=Auth',
